...
<html>
<head>
<title>View Uploaded File Details Here</title>
 ...
 <body class="sticky-header left-side-collapsed"  onload="initMap()">
    <section>
		<div class="left-side sticky-left-side">
			...
			<div class="left-side-inner">
					<ul class="nav nav-pills nav-stacked custom-nav">
						<li class="active"><a href="admin_home.jsp"><i class="lnr lnr-power-switch"></i><span>Dashboard</span></a></li>
		...
		<% 
            ...
            ResultSet resultset =statement.executeQuery("select Username,Filename,Proof,Fileid from file_storage") ; 
