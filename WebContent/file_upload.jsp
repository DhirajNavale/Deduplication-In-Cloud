...
<div class="container"  align="center">
  ...
  <div class="panel panel-default" style="width: 50%">
    <div class="panel-heading"><h4>File Upload</h4></div>
    <div class="panel-body">
    
    
     <form action="GenerateTag" method="post" enctype="multipart/form-data"> 
   
   <!--  <form action="userUploadingController" method="post" enctype="multipart/form-data"> --> 
