...
<head>
	...
	<title>Prove Ownership Here</title>
...
<% 
	...
	{
%>
<% session.setAttribute("Tag", session.getAttribute("Tag"));
%>
...
<div class="container"  align="center">
  ...
  <div class="panel panel-default" style="width: 50%">
    <div class="panel-heading"><h4>Enter Details To prove ownership</h4></div>
    <div class="panel-body">
    <form action="Proof" method="post" autocomplete="off">
        <div class="form-group" align="left">
            <input type="text" name="email" placeholder="Enter Your Mail ID" class="form-control" required>
        </div>
        <div align="left">
        <button type="submit" class="btn btn-success">Prove</button>
